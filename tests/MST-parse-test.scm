...
; Parse the sentences
(define parse-1 (observe-mst-mode test-str-1 cnt-mode dist-mult -20 "#f"))
(define parse-2 (observe-mst-mode test-str-2 cnt-mode dist-mult -20 "#f"))
...
; Parse the sentences
(set! parse-1 (observe-mst-mode test-str-1 cnt-mode dist-mult -20 "#f"))
(set! parse-2 (observe-mst-mode test-str-2 cnt-mode dist-mult -20 "#f"))
...
; Parse the sentences
(set! parse-1 (observe-mst-mode text-block cnt-mode dist-mult -20 "#f"))
...
; Parse the sentences
(set! parse-2 (observe-mst-mode text-block cnt-mode dist-mult -20 "#f"))
